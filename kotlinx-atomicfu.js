(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).z1j = function () {
    return this.y1j_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.y1j_1[index];
  };
  ...
  protoOf(AtomicInt).a1k = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).b1k = function () {
  ...
  protoOf(AtomicBoolean).c1k = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).b1k = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicRef).d1k = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).b1k = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).e1k = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).b1k = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).z1j);
  //endregion
