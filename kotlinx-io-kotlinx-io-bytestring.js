(function (factory) {
  ...
  var toCharArray = kotlin_kotlin.$_$.oe;
  ...
  protoOf(ByteString).y1f = function (startIndex, endIndex) {
    var tmp;
  ...
  protoOf(ByteString).s1g = function (startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.e1() : endIndex;
    return $super === VOID ? this.y1f(startIndex, endIndex) : $super.y1f.call(this, startIndex, endIndex);
  };
  protoOf(ByteString).t1g = function (other) {
    if (other === this)
      return 0;
  ...
  protoOf(ByteString).d = function (other) {
    return this.t1g(other instanceof ByteString ? other : THROW_CCE());
  };
  protoOf(ByteString).toString = function () {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.s(Companion_getInstance().o1g_1[(b >>> 4 | 0) & 15]);
        $this$with.s(Companion_getInstance().o1g_1[b & 15]);
      }
       while (inductionVariable < last);
  ...
  function decodeToString_0(_this__u8e3s4) {
    return decodeToString(_this__u8e3s4.u1g());
  }
  ...
  protoOf(UnsafeByteStringOperations).v1g = function (array) {
